...
## Configuration
**Library Path**: `D:/Coding/pp/slides-maker/templates`
...
2.  **Copy Template**: Recursively copy the template folder to the user's requested destination.
    - Example: `cp -r D:/Coding/pp/slides-maker/templates/template-01-minimal/* ./my-new-slides/`
3.  **Copy Server**: Copy `server.js` from the parent of Library Path to the destination.
    - Example: `cp D:/Coding/pp/slides-maker/templates/../server.js ./my-new-slides/`
